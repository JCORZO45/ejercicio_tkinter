...
def calcular():
    ...
    if int(x.get())>int(y.get()) and int(x.get())>int(z.get()):
        t_resultados.insert(INSERT, "El Número mayor mayor es:  " +str(int(x.get())))
    elif int(y.get())>int(x.get()) and int(y.get())>int(z.get()):
        t_resultados.insert(INSERT, "El NÚmero mayor es:  " +str(int(y.get())))
    elif int(z.get())>int(x.get()) and int(z.get())>int(y.get()):
        t_resultados.insert(INSERT, "El Número mayor es:  " +str(int(z.get())))
    elif int(x.get())==int(y.get()) and int(x.get())==int(z.get()):
        t_resultados.insert(INSERT, "Todos los números son iguales")
...
# etiqueta para y
lb_y = Label(frame_entrada, text = "Número b= ")
...
#entiqueta para z
lb_z = Label(frame_entrada, text = "Número c = ")
